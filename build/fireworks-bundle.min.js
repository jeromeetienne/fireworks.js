...
Fireworks.EffectAge=function(a){this.onCreate=function(a){a.xAge={curAge:0,maxAge:0}}.bind(this);this.onBirth=function(a){a=a.xAge;a.curAge=0;a.maxAge=3E3}.bind(this);this.onUpdate=function(b,c){var d=b.xAge;d.curAge+=c;d.curAge>d.maxAge&&a.killParticle(b)}.bind(this)};Fireworks.EffectAge.prototype=new Fireworks.Effect;Fireworks.EffectAge.prototype.constructor=Fireworks.EffectAge;
Fireworks.EffectBase=function(){this.onCreate=function(a){a.xBase={x:0,y:0,z:0,velocityX:0,velocityY:0,velocityZ:0}}.bind(this);this.onBirth=function(a){a=a.xBase;a.x=0;a.y=0;a.z=0;a.x=window.innerWidth/2;a.y=window.innerHeight/2;a.velocityX=12*(Math.random()-0.5);a.velocityY=12*(Math.random()-0.5);a.velocityZ=12*(Math.random()-0.5)}.bind(this);this.onUpdate=function(a){a=a.xBase;a.x+=a.velocityX;a.y+=a.velocityY;a.z+=a.velocityZ}.bind(this)};Fireworks.EffectBase.prototype=new Fireworks.Effect;
Fireworks.EffectBase.prototype.constructor=Fireworks.EffectBase;Fireworks.SpawnerRate=function(){};Fireworks.SpawnerRate.prototype=new Fireworks.Spawner;Fireworks.SpawnerRate.prototype.constructor=Fireworks.SpawnerRate;Fireworks.SpawnerRate.prototype.update=function(a){var b;b=Math.min(1,a.deadParticles().length);for(var c=0;c<b;c++)a.spawnParticle()};
