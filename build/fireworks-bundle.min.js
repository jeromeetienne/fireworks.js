...
Fireworks.Emitter.prototype.intensity=function(a){if(void 0===a)return this._intensity;if(a===this._intensity)return this;console.assert(0<=a,"Fireworks.Emitter.intensity: invalid value.",a);console.assert(1>=a,"Fireworks.Emitter.intensity: invalid value.",a);var b=this._intensity;this._intensity=a;this._effects.forEach(function(a){if(a.onIntensityChange)a.onIntensityChange(this._intensity,b)}.bind(this));return this};
Fireworks.Emitter.prototype.maxDeltaTime=function(a){if(void 0===a)return this._maxDeltaTime;this._maxDeltaTime=a;return this};Fireworks.Emitter.prototype.setParticleData=function(a,b,c){a.set(b,c)};Fireworks.Emitter.prototype.getParticleData=function(a,b){return a.get(b)};
...
Fireworks.createLinearGradient=function(a){return new Fireworks.LinearGradient(a)};Fireworks.LinearGradient=function(){this._keyPoints=[]};Fireworks.LinearGradient.prototype.push=function(a,b){this._keyPoints.push({x:a,y:b});return this};
...
Fireworks.Particle.prototype.get=function(a){console.assert(void 0!==this[a],"key undefined: "+a);return this[a]};Fireworks.Particle.prototype.has=function(a){return void 0!==this[a]?!0:!1};Fireworks.Shape=function(){};Fireworks.createVector=function(a,b,c){return new Fireworks.Vector(a,b,c)};Fireworks.Vector=function(a,b,c){this.x=a||0;this.y=b||0;this.z=c||0};
...
Fireworks.EffectsStackBuilder.prototype.velocity=function(a,b){Fireworks.createEffect("velocity",{shape:a,speed:void 0!==b?b:-1}).onCreate(function(a){a.set("velocity",{vector:new Fireworks.Vector})}).onBirth(function(a){a=a.get("velocity").vector;this.opts.shape.randomPoint(a);-1!==this.opts.speed&&a.setLength(this.opts.speed)}).onUpdate(function(a,b){var f=a.get("position").vector,e=a.get("velocity").vector;f.x+=e.x*b;f.y+=e.y*b;f.z+=e.z*b}).pushTo(this._emitter);return this};
...
Fireworks.ShapeSphere.prototype.randomPoint=function(a){a=a||this._vector;a.x=Math.random()-0.5;a.y=Math.random()-0.5;a.z=Math.random()-0.5;var b=Math.random()*this.radius;a.setLength(b);a.addSelf(this.center);return a};
Fireworks.EffectsStackBuilder.prototype.spawnerOneShot=function(a){var a=a||this.emitter().nParticles(),b=this.emitter(),c=0,d=!0;Fireworks.createEffect("spawner",{start:function(){d=!0},stop:function(){d=!1}}).onPreUpdate(function(){if(!1!==d&&a!==c){for(var f=a-c,f=Math.min(f,b.deadParticles().length),e=0;e<f;e++)b.spawnParticle();c+=f}}).pushTo(this._emitter);return this};
...
b.set(a.x,a.y,a.z)}).pushTo(this._emitter);return this};Fireworks.Emitter.prototype.bindTriggerDomEvents=function(a){new Fireworks.BindTriggerDomEvents(this,a);return this};
