...
Fireworks.Emitter.prototype.effects=function(){return this._effects};Fireworks.Emitter.prototype.particles=function(){return this._particles};Fireworks.Emitter.prototype.liveParticles=function(){return this._liveParticles};Fireworks.Emitter.prototype.deadParticles=function(){return this._deadParticles};Fireworks.Emitter.prototype.nParticles=function(){return this._nParticles};Fireworks.Emitter.prototype.effectsStackBuilder=function(){return this._effectsStackBuilder};
Fireworks.Emitter.prototype.setSpawner=function(a){this._spawner=a;return this};Fireworks.Emitter.prototype.setParticleData=function(a,b,c){a.set(b,c)};Fireworks.Emitter.prototype.getParticleData=function(a,b){return a.get(b)};
...
Fireworks.Particle.prototype.set=function(a,b){console.assert(void 0===this[a],"key already defined: "+a);this[a]=b;return this};Fireworks.Particle.prototype.get=function(a){console.assert(void 0!==this[a],"key undefined: "+a);return this[a]};Fireworks.EffectsStackBuilder=function(a){this._emitter=a};Fireworks.EffectsStackBuilder.prototype.back=function(){return this._emitter};Fireworks.EffectsStackBuilder.prototype.createEffect=function(a,b){return Fireworks.createEffect(a,b).pushTo(this._emitter).back(this)};
Fireworks.createEffect=function(a,b){"object"===typeof a&&(b=a,a=void 0);console.log("createEffect",a,b);var c=new Fireworks.Effect;c.opts=b;c.name=a;c.back=null;var d={onCreate:function(a){c.onCreate=a;return d},onBirth:function(a){c.onBirth=a;return d},onUpdate:function(a){c.onUpdate=a;return d},onDeath:function(a){c.onDeath=a;return d},onPreRender:function(a){c.onPreRender=a;return d},onRender:function(a){c.onRender=a;return d},pushTo:function(a){a.effects().push(c);return d},back:function(a){if(a===
void 0)return c.back;c.back=a;return d},effect:function(){return c}};return d};Fireworks.Effect=function(){};Fireworks.Shape=function(){};Fireworks.createVector=function(a,b,c){return new Fireworks.Vector(a,b,c)};Fireworks.Vector=function(a,b,c){this.x=a||0;this.y=b||0;this.z=c||0};
