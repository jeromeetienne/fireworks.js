...
Fireworks.Emitter.prototype.update=function(a){this._effects.forEach(function(b){if(b.onPreUpdate)b.onPreUpdate(a)}.bind(this));this._effects.forEach(function(b){b.onUpdate&&this._liveParticles.forEach(function(c){b.onUpdate(c,a)})}.bind(this));return this};
