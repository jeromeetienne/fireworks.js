var Fireworks={EffectsStackBuilder:function(a){this._emitter=a}};Fireworks.EffectsStackBuilder.prototype.back=function(){return this._emitter};Fireworks.EffectsStackBuilder.prototype.createEffect=function(a,b){return Fireworks.createEffect(a,b).pushTo(this._emitter).back(this)};
...
a;return d},pushTo:function(a){a.effects().push(c);return d},back:function(a){if(a===void 0)return c.back;c.back=a;return d},effect:function(){return c}};return d};Fireworks.Effect=function(){};Fireworks.createEmitter=function(a){return new Fireworks.Emitter(a)};Fireworks.Emitter=function(a){this._nParticles=void 0!==a.nParticles?a.nParticles:100;this._particles=[];this._spawner=null;this._effects=[];this._started=!1;this._onUpdated=null;this._intensity=0;this._effectsStackBuilder=new Fireworks.EffectsStackBuilder(this)};
Fireworks.Emitter.prototype.destroy=function(){this._effects.forEach(function(a){a.destroy()});this._spawner&&this._spawner.destroy();this._particles.forEach(function(a){a.destroy()})};Fireworks.Emitter.prototype.effects=function(){return this._effects};Fireworks.Emitter.prototype.effectByName=function(a){for(var b=0;b<this._effects.length;b++){var c=this._effects[b];if(c.name===a)return c}return null};Fireworks.Emitter.prototype.particles=function(){return this._particles};
Fireworks.Emitter.prototype.liveParticles=function(){return this._liveParticles};Fireworks.Emitter.prototype.deadParticles=function(){return this._deadParticles};Fireworks.Emitter.prototype.nParticles=function(){return this._nParticles};Fireworks.Emitter.prototype.effectsStackBuilder=function(){return this._effectsStackBuilder};Fireworks.Emitter.prototype.spawner=function(a){if(void 0===a)return this._spawner;this._spawner=a;return this};
